...
public class SlistSortTest{
	...
	private void testRandom(String method) {
		...
		for (int i = 5000; i < 25000; i = i + 5000) {
			...
			int [] a = u.generateRandomNumber(j,false,0,j/10); //So that there will be negatives and duplicates
			System.out.println(" ============================================= " ); 
	...
	private void testAllreadySorted(String method) {
		...
		for (int i = 5000; i < 25000; i = i + 5000) {
			if (t == false) {
				j = i - 1; //odd
				t = true ;
				int [] a = u.generateNumberInIncreasingOrder(j,1); //2 sequences of sorted so diplicates will be there
				System.out.println(" ============================================= " ); 
				System.out.println("Running  " + method + " on " + a.length + " Already increasing order with duplicates");
				Slist2 s = Slist2.buildSlist(a) ;
				sort1(s,method) ;
				System.out.println(" ============================================= " );
			}else {
	...
	public static void main(String[] args) {
		//Change path below
		String s = "/Users/rutuja/Desktop/Courses/INFO6205/HW5_SlistSort/expectedoutput.txt";
